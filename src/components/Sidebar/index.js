...
<div className='nav-bar'>
    ...
    <ul>
        <li>
            <a target="_blank" rel='noreferrer' href='https://www.linkedin.com/in/sushant-mahadwad-67bb26220/'>
                <FontAwesomeIcon icon={faLinkedin} color='#4d4d4e'/>
            </a>
        </li>
        <li>
            <a target="_blank" rel='noreferrer' href='https://github.com/SUSHANT0002/'>
                <FontAwesomeIcon icon={faGithub} color='#4d4d4e'/>
            </a>
        </li>
        <li>
            <a target="_blank" rel='noreferrer' href='https://www.instagram.com/sushantmahadwad/'>
